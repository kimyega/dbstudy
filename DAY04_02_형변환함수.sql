...
/*
    ...
    2. 'X' 값을 가지고 있다.
    3. FROM 절이 필요 없는 SELECT문을 사용할 때 DUAL 테이블을 이용한다.
*/

-- 데이터 타입변환 : 숫자, 날짜, 문자 등의 데이터타입을 바꿈
/*
    1.문자 --> 숫자로 변환
        TO_NUMBER(문자)
*/
...
*/
SELECT TO_CHAR(1234)
     , TO_CHAR(1234,'999999')       -- '  1234' 폭 조정 9 개수  자리수
...
SELECT SYSDATE      -- '23/07/04'
     , SYSTIMESTAMP -- '20/07/04 14:46:44.303000000 +09:00'
  FROM DUAL;
-- 현재 날짜와 시간 - 형식 짖ㅇ
...
-- DT1 이 '23/07/04'인 데이터를 조회하기 (안 됨)
